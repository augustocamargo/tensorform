"""
Benchmark: tform.audio.gammatone — CelebVox dataset
====================================================

Usage
-----
    python benchmarks/audio/gammatone_celeb_vox.py
    python benchmarks/audio/gammatone_celeb_vox.py --max-files 100 --iterations 20 --warmup 5
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="HAC Gammatone — CelebVox benchmark")
...
def main() -> None:
    ...
    report.print_summary("tform.audio.gammatone — CelebVox", run_config=run_config, dataset_stats=dataset_stats)
    report.save_report("tform.audio.gammatone — CelebVox", operator_slug="gammatone", run_config=run_config, dataset_stats=dataset_stats)
