"""
Benchmark: tform.audio.melt (Direct Mel Projection) — CelebVox dataset
=======================================================================
Paper configuration: spectral frontend, N=400 (25 ms), M=80 bins.

Reference: Camargo & Finger, MelT arXiv 2026, Table 3.

Usage
-----
    python benchmarks/audio/melt_celeb_vox.py
    python benchmarks/audio/melt_celeb_vox.py --max-files 100 --iterations 20 --warmup 5
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="HAC MelT — CelebVox benchmark")
...
def main() -> None:
    ...
    report.print_summary("tform.audio.melt — CelebVox", run_config=run_config, dataset_stats=dataset_stats)
    report.save_report("tform.audio.melt — CelebVox", operator_slug="melt", run_config=run_config, dataset_stats=dataset_stats)
